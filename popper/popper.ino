...
void setup() {
  ...
  Serial.print("SSR Pin: "); Serial.println(SSR_PIN);
  Serial.print("Cycle Length: "); Serial.print(CYCLE_LENGTH_MS); Serial.println(" ms");
}
...
void loop() {
  ...
  if (currentTime - lastDebugPrintTime >= 2000) { // Print debug info every 2 seconds
    lastDebugPrintTime = currentTime;
    Serial.print("Modbus Power Set (Reg4): "); Serial.print(au16data[4]);
    Serial.print(" -> Actual Power%: "); Serial.print(powerPercent);
    Serial.print(", ON_Time_ms: "); Serial.print(onTimeMs);
    Serial.print(", SSR State: "); Serial.println(digitalRead(SSR_PIN) == HIGH ? "ON" : "OFF");
    Serial.print("Temp1: "); Serial.print(tempC1); Serial.print("C (Reg2: "); Serial.print(au16data[2]); Serial.println(")");
    Serial.print("Temp2: "); Serial.print(tempC2); Serial.print("C (Reg3: "); Serial.print(au16data[3]); Serial.println(")");
    Serial.println("---");
  }
}
